...
class _DropDownUniversityState extends State<DropDownUniversity> {
      ...
      child: BlocConsumer<UniversityBloc, UniversityState>(
        ...
        builder: (context, state) {
          if (state is UniversityLoading) {
            ...
            universities = state.universities.toList();
            UniversityModel universityModel = universities.firstWhere((u) => u.id == widget.uniId,);
            return _dropDownUniversityLoaded(universityModel);
          }
          return Center(
  ...
  DropdownButtonFormField<String> _dropDownUniversityLoaded(UniversityModel universityModel) {
    return DropdownButtonFormField(
      ...
      value: universityModel.universityName ,
