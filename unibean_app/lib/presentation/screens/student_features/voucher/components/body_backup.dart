...
class BodyBackUp extends StatefulWidget {
  const BodyBackUp({super.key, required this.studentId});
  final String studentId;

  @override
  State<BodyBackUp> createState() => _BodyState();
}

class _BodyState extends State<BodyBackUp> {
  ...
  void initState() {
    scrollController.addListener(() {
      context
          .read<StudentBloc>()
          .add(LoadMoreStudentVouchers(scrollController, id: widget.studentId, isUsed: true));
    });
    super.initState();
  }
    ...
    return BlocListener<InternetBloc, InternetState>(
      ...
      child: RefreshIndicator(
        onRefresh: () async {
          context
              .read<StudentBloc>()
              .add(LoadStudentVouchers(id: widget.studentId, isUsed: true));
        },
